...
* ### 2 - Percentual de votos :inbox_tray:
...
* ### 5 - Salário vendedor :money_with_wings:
...
* ### 6 - Fahrenheit para Celsius :shower:
...
* ### 8 - Positivo ou negativo :heavy_plus_sign: :heavy_minus_sign:
...
* ### 11 - Idade permitida para votar :underage:
...
* ### 13 - Ordem crescente dos números :1234:
...
* ### 14 - Duração partida de Xadrez :horse:
...
* ### 16 - Gastos do trimestre :money_with_wings:
